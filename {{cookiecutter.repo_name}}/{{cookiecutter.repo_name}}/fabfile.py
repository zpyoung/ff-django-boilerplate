...
BASE_LOCAL_SETTINGS = """SITE_URL=https://${node_site}
DJANGO_SITE_URL=https://${django_site}
ALLOWED_HOSTS=${allowed_hosts}
"""

DJANGO_LOCAL_SETTINGS = """SECRET_KEY=${secret_key}
${site_settings}
DATABASE_HOST=postgres
DATABASE_PORT=5432
DATABASE_NAME=the_platform
DATABASE_USER=the_platform
...
def add_secret_keys(component=None):
    ...
    if component == 'node':
        remote_path = env.code_dir + '/app/env/node.env'
    else:
        remote_path = env.code_dir + '/the_platform/django.env'
